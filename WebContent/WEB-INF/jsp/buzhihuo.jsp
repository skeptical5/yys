...
<div class="col" style="">
<div style="float:left;width:50px;height:300px;background-image: url(${pageContext.request.contextPath}/img/name_box.png);"><img  style="margin-top:60px;margin-left:-15px;" src="${pageContext.request.contextPath}/img/ssr.png"><p style="font-size:1.75em;margin-top:0px;margin-left:15px;">不知火</p></div>
<div style="float:left;width:60%;height:500px;">
<img id="img1" src="${pageContext.request.contextPath}/img/buzhihuo_1.png">
</div>
...
<p class="zhuanjiw">原本黑寂的海面上，突然出现了一束火光。</p>
<p class="zhuanjiw">火光分裂，滋生，最终成百上千，沿着海面直达天际。这便是大妖怪不知火的传说，它深深地烙印在每一个杏原人的脑海里。</p>
<p class="zhuanjiw">每过数十年，不知火便会降临在杏原的海面，带来福祉抑或灾难。</p>
<p class="zhuanjiw">不过，传说归传说，真正见过不知火的人，却是寥寥无几。而我，却被赋予了这个神秘又不祥的名字。</p>
</div>
</div>
...
$("[name='btn_chushi']").click(function(){
	document.getElementById('img1').src = "${pageContext.request.contextPath}/img/buzhihuo_1.png"
})
$("[name='btn_juexing']").click(function(){
	document.getElementById('img1').src = "${pageContext.request.contextPath}/img/buzhihuo_2.png"
})
$("[name='btn_pifu']").click(function(){
	document.getElementById('img1').src = "${pageContext.request.contextPath}/img/buzhihuo_3.png"
})
</script>
</html>