...
<div class="card">
  ...
  <div class="card-body">
    <p class="card-text" style="color:red"> ${info} </p>
    <form method="post" action="${pageContext.request.contextPath}/admin/RegActionAjax">
  ...
  <div class="form-group">
									...
									<div class="col-sm-4">
									<input
										type="text" class="form-control" id="jym" 
										 name="jym" placeholder="校验码">
										</div>
										</div>
								</div>
  <small id="emailHelp" class="form-text text-muted">注册即代表同意《服务条款》</small>
  <button type="submit" id = "regBtn" class="btn btn-outline-danger">注册</button>
</form>
  </div>
</div>
